...
func webApiInitRoutes(app *fiber.App) *domain.Domain {
	...
	app.All(conf.API_PREFIX+domain.DeleteFruit_Url, func(ctx *fiber.Ctx) error {
		url := domain.DeleteFruit_Url
	...
	app.All(conf.API_PREFIX+domain.DeleteFruitProducts_Url, func(ctx *fiber.Ctx) error {
		url := domain.DeleteFruitProducts_Url
		tracerCtx, span := conf.T.Start(ctx.Context(), url, trace.WithSpanKind(trace.SpanKindServer))
		defer span.End()
	...
	app.All(conf.API_PREFIX+domain.FruitProducts_Url, func(ctx *fiber.Ctx) error {
		url := domain.FruitProducts_Url
		tracerCtx, span := conf.T.Start(ctx.Context(), url, trace.WithSpanKind(trace.SpanKindServer))
		defer span.End()
	...
	app.All(conf.API_PREFIX+domain.InsertFruit_Url, func(ctx *fiber.Ctx) error {
		url := domain.InsertFruit_Url
		tracerCtx, span := conf.T.Start(ctx.Context(), url, trace.WithSpanKind(trace.SpanKindServer))
		defer span.End()
	...
	app.All(conf.API_PREFIX+domain.InsertFruitProducts_Url, func(ctx *fiber.Ctx) error {
		url := domain.InsertFruitProducts_Url
		tracerCtx, span := conf.T.Start(ctx.Context(), url, trace.WithSpanKind(trace.SpanKindServer))
		defer span.End()
	...
	app.All(conf.API_PREFIX+domain.RestoreFruit_Url, func(ctx *fiber.Ctx) error {
		url := domain.RestoreFruit_Url
		tracerCtx, span := conf.T.Start(ctx.Context(), url, trace.WithSpanKind(trace.SpanKindServer))
		defer span.End()
	...
	app.All(conf.API_PREFIX+domain.RestoreFruitProducts_Url, func(ctx *fiber.Ctx) error {
		url := domain.RestoreFruitProducts_Url
		tracerCtx, span := conf.T.Start(ctx.Context(), url, trace.WithSpanKind(trace.SpanKindServer))
		defer span.End()
	...
	app.All(conf.API_PREFIX+domain.UpdateFruit_Url, func(ctx *fiber.Ctx) error {
		url := domain.UpdateFruit_Url
		tracerCtx, span := conf.T.Start(ctx.Context(), url, trace.WithSpanKind(trace.SpanKindServer))
		defer span.End()
	...
	app.All(conf.API_PREFIX+domain.UpdateFruitProducts_Url, func(ctx *fiber.Ctx) error {
		url := domain.UpdateFruitProducts_Url
		tracerCtx, span := conf.T.Start(ctx.Context(), url, trace.WithSpanKind(trace.SpanKindServer))
		defer span.End()
